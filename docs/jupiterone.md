...
2. An InsightVM Username and Password
   - Use an existing user or create a user that at least the [Security Manager and Site Owner Role](https://docs.rapid7.com/insightvm/managing-users-and-authentication/#security-manager-and-site-owner)
